...
def plot_all_losses(train_losses):
	...
	plt.savefig('graph_batch_loss_06_06_19_classification.png')
	plt.close()
...
def plot_losses(train_losses, dev_losses):
	...
	plt.savefig("graph_train_loss_06_06_19_classification.png")
	plt.close()
	plt.plot(range(len(dev_losses)), dev_losses)
	plt.xlabel('Epoch')
	plt.ylabel('Loss')
	plt.title('Dev Loss')
	plt.savefig("graph_dev_loss_06_06_19_classification.png")
	plt.close()
	print('Saved graph!')
